...
export const getAllJobs = async (req, res) => {
   ...
   // if jobStatus exist and is not 'all'
...
export const updateJob = async (req, res) => {
   ...
   res.status(StatusCodes.OK).json({ ms: 'job modified', job: updatedJob})
}
...
export const deleteJob = async (req, res) => {
   ...
   res.status(StatusCodes.OK).json({ ms: 'job deleted', job: removedJob})
}
